    ...
    <div>
      ...
      <div className="container flex flex-col items-center justify-center mt-4">
        ...
        <form onSubmit={handleLogin} className="w-full mt-3 flex flex-col items-center justify-center gap-2 lg:gap-3">
          <input className="outline-[#2B4257] p-2 md:p-3 xl:p-4 w-[90%] sm:w-[400px] md:w-[450px] h-[35px] sm:h-[40px] md:h-[45px] text-[12px] sm:text-[15px] lg:text-[17px] border-[1px] border-[#091235] rounded-md" 
                 type="email" value={email} onChange={handleLoginChange} required placeholder="Enter your Login" />
          <input className="outline-[#2B4257] p-2 md:p-3 xl:p-4 w-[90%] sm:w-[400px] md:w-[450px] h-[35px] sm:h-[40px] md:h-[45px] text-[12px] sm:text-[15px] lg:text-[17px] border-[1px] border-[#091235] rounded-md" 
        ...
        <button onClick={handleGoogleLogin} className="mt-2 w-[90%] sm:w-[400px] md:w-[450px] h-[35px] sm:h-[40px] md:h-[45px] flex items-center justify-center gap-1 text-[12px] sm:text-[15px] lg:text-[17px] border-[1px] border-[#091235] rounded-md bg-transparent">
          <Image className="w-[25px] h-[25px]" src={GoogleIcon} alt="Google icon" /> Sign In with Google
        </button>
        {error ? <p className="mt-2 text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] text-red-500 text-center">Login or password wrong! Please try again.</p> : null}
        {emailPassword ? <p className="mt-2 text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] text-red-500 ">Your login must end with @gmail.com</p> : false }
        {showModal && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-500 bg-opacity-50 z-50">
          <div className="bg-white p-6 rounded-lg shadow-lg w-[80%] sm:w-96">
            ...
            <button onClick={closeModal} className="mt-4 w-full bg-red-500 text-[12px] sm:text-[16px] lg:text-[18px] text-white py-2 rounded-md transition-all hover:bg-[#935F4C]">{modalMessage && modalMessage.startsWith('😊 Dear') 
