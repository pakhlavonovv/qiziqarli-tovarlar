...
const Footer = () => {
    return (
        <footer className='w-full bg-[#0f172a] p-4'>
                    <i>
                        <h1 className="container cursor-pointer text-white text-[25px] font-extrabold sm:text-[30px] lg:text-[35px] xl:text-[40px] text-center sm:text-start">Xo‘ji aka</h1>
                    </i>
