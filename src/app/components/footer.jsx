        ...
        <footer className='w-full bg-[#050505] p-4'>
            ...
            <div className="w-[95%] mx-auto grid grid-cols-1 lg:mt-[30px] justify-between gap-5 p-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 md:gap-[100px] lg:gap-[130px] xl:gap-[160px]">
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <Link target='_blank' href={'mailto:abdullokhpakhlavonov@gmail.com'} className='text-white text-[12px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px] transition-all hover:text-[#88A9C3]'>abdullokhpakhlavonov@gmail.com</Link>
                ...
                <div className="flex flex-col gap-5">
                   ...
                   <Link target='_blank' href={'/'}> <i className="fa-brands fa-instagram text-white text-[9px] sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[25px] transition-all hover:text-[#88A9C3] fa-xl"></i></Link>
